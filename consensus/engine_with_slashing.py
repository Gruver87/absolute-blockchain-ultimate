# consensus/engine_with_slashing.py
"""
Consensus Engine with Slashing Integration
"""
...
class ConsensusEngineSlashing:
    ...
    def add_validator(self, validator_id: str, stake: int = 100):
        ...
        self.finality.set_total_stake(self._get_active_stake())
    ...
    def on_attestation(self, validator_id: str, block_hash: str, slot: int) -> bool:
        ...
        # 1. SLASHING FIRST (before LMD update)
        ...
        # 2. Get active stake for this validator
        active_validators = self.slashing.get_active_validators(self._validators)
        ...
        # Update total stake for finality
        self.finality.set_total_stake(self._get_active_stake())
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            "active_validators": len(self.slashing.get_active_validators(self._validators)),
    ...
    def get_slashing_info(self) -> dict:
        return self.slashing.get_slashing_info()
