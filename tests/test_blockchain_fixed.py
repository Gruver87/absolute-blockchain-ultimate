...
# ПОЛНОЕ ТЕСТИРОВАНИЕ ВСЕХ КОМПОНЕНТОВ (ИСПРАВЛЕННАЯ ВЕРСИЯ)
...
# ============================================================================
# 4. ТЕСТ БЛОКА (С МАЙНИНГОМ)
# ============================================================================

def test_block():
    print("\n" + "=" * 60)
    print("🧪 ТЕСТ 4: БЛОК С МАЙНИНГОМ")
    print("=" * 60)
    ...
    try:
        ...
        print(f"✅ Блок #{block.height} (difficulty={block.difficulty})")
...
def test_self_healing():
    ...
    try:
        ...
        block1 = Block(0, "0"*64, txs, "genesis", difficulty=1)
        block1.block_hash = block1.calculate_hash()
        
        block2 = Block(1, "wrong_hash", txs, "validator", difficulty=1)
